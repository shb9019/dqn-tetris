...
class Engine:
    def __init__(self, width, height):
        ...
        self.avm = dict([(j, i) for i, j in self.vam.items()])
        self.nb_actions = len(self.vam)
    ...
    def step(self, action):
        ...
        if (self.vam[action] == 'right'):
            print("Here")
        self.shape, self.anchor = self.vam[action](self.shape, self.anchor, self.board)
